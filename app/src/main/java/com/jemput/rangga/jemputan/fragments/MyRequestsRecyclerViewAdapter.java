...
import com.jemput.rangga.jemputan.fragments.RequestsFragment.OnListFragmentInteractionListener;
...
public class MyRequestsRecyclerViewAdapter extends RecyclerView.Adapter<MyRequestsRecyclerViewAdapter.ViewHolder> {
    ...
    public MyRequestsRecyclerViewAdapter(List<Student> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (null != mListener) {
                    ...
                    mListener.onListFragmentInteractionRequest(holder.mItem);
                }
            }
        });
    }
