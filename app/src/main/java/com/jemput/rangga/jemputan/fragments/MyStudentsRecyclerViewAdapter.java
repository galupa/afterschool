...
import com.jemput.rangga.jemputan.fragments.StudentsFragment.OnListFragmentInteractionListener;
...
public class MyStudentsRecyclerViewAdapter extends RecyclerView.Adapter<MyStudentsRecyclerViewAdapter.ViewHolder> {
    ...
    public MyStudentsRecyclerViewAdapter(List<Student> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mContentView.setText(mValues.get(position).getParentName());
        holder.mStatusView.setText(mValues.get(position).getStatusString());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            mStatusView = (TextView) view.findViewById(R.id.studentStatus);
        }
